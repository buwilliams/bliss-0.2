...
module.exports = {
  "workspace": process.env.BLISS_DIR + process.env.BLISS_WORKSPACE,
  "app": process.env.BLISS_DIR + process.env.BLISS_APP,
  "node_modules": process.env.BLISS_DIR + process.env.BLISS_NODE_MODULES,
