var newProject = (function() {
  var createApp = function(component) {
    ...
    app.methods["2"] = {};
    app.methods["2"]['new_1'] = function(scope, attributes) {
      return null;
    }
    app.getKey = function() {
      var out = [];
    ...
    app.rootComponent = function(props) {
      ...
      return (
        React.createElement('div', app.mergeAttributes('1', scope, {}, {
          ...
          React.createElement('header', app.mergeAttributes('2', scope, {}, {
            "id": "header_2",
            "key": app.getKey('id', '2')
          }), 'Smile, there are less than days until 45 is gone'),
          React.createElement('main', app.mergeAttributes('3', scope, {}, {
            "id": "main_3",
            "key": app.getKey('id', '3')
          })),
