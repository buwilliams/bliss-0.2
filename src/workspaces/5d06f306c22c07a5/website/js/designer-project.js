var blissProject = {
  ...
  "components": {
    ...
    "8": {
      ...
      "name": "small header",
      "element": "small",
      "text": "Get Your Inspiration Back",
      "textFn": null,
      "ifFn": null,
      "repeatFn": null,
      "attributes": [
    ...
    "17": {
      ...
      "name": "para",
      "element": "p",
      "text": "BlissUI helps you rapidly prototype and experiment with the ideas you have. You can realistically build and publish an app in a few short minutes. So it’s a great way to explore your ideas and it’s a fun experience.",
      "textFn": null,
      "ifFn": null,
      "repeatFn": null,
      "attributes": [],
    ...
    "58": {
      ...
      "name": "para",
      "element": "p",
      "text": "Introducing BlissUI, get your inspiration back.",
      "textFn": null,
      "ifFn": null,
      "repeatFn": null,
      "attributes": [],
    ...
    "60": {
      ...
      "name": "para",
      "element": "p",
      "text": "The mission is simple yet enormous, we want to remove all barriers that prevent pure creation. To bring back that thing that makes us uniquely human, to take a step in the land of dreams. But hey, maybe we’re crazy.",
      "textFn": null,
      "ifFn": null,
      "repeatFn": null,
      "attributes": [],
    ...
    "63": {
      ...
      "name": "span",
      "element": "span",
      "text": " built for one aim, to free you. BlissUI removes technical barriers so that you can focus on pure creation. Why? Your inspiration is trapped behind a mountain of to-dos, business constraints, tech culture, and technical details. Our inspiration has been taken from us and… we don’t even know it. The same old is killing us. It wasn’t done on purpose but sadly, we’re so used to it we stopped caring. It’s time for a change. It’s time to see the sunrise, to feel its warmth.",
      "textFn": null,
      "ifFn": null,
      "repeatFn": null,
      "attributes": [],
