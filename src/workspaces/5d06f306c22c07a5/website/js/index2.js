              ...
              React.createElement('div', app.mergeAttributes('80', scope, {}, {
                ...
                React.createElement('div', app.mergeAttributes('82', scope, {}, {
                  ...
                  React.createElement('div', app.mergeAttributes('85', scope, {}, {
                    ...
                    React.createElement('h1', app.mergeAttributes('83', scope, {}, {
                      "id": "spaSlow_83",
                      "key": app.getKey('id', '83')
                    }), 'Building single page apps is slow and complicated.'),
                    React.createElement('h2', app.mergeAttributes('84', scope, {}, {
                      "id": "textEditors_84",
                      "key": app.getKey('id', '84')
                    }), 'Texts editors were not designed for the web.'),
                    React.createElement('div', app.mergeAttributes('86', scope, {}, {
                      ...
                      React.createElement('div', app.mergeAttributes('89', scope, {}, {
                        "className": "card",
                        "id": "share_89",
