    ...
    app.rootComponent = function(props) {
      ...
      return (
        React.createElement('div', app.mergeAttributes('1', scope, {}, {
          ...
          React.createElement('div', app.mergeAttributes('29', scope, {}, {
            ...
            React.createElement('div', app.mergeAttributes('27', scope, {}, {
              ...
              React.createElement('div', app.mergeAttributes('31', scope, {}, {
                ...
                React.createElement('h1', app.mergeAttributes('30', scope, {}, {
                  "id": "header_30",
                ...
                }), 'Welcome the home of the best freakin\' fried chicken that your momma never made.'))))));
    };
    app.render = function() {
