var buddy = (function() {
  var createApp = function(component) {
    ...
    app.methods["4"] = {};
    app.methods["4"]['food_name'] = function(scope, attributes) {
      //console.log('scope', scope, 'attributes', attributes)
      return scope.food[scope.food_index]
    };

    app.methods["4"]['food'] = function(scope, attributes) {
      ...
      return (
        React.createElement('div', app.mergeAttributes('1', scope, {}, {
          ...
          React.createElement('div', app.mergeAttributes('7', scope, {}, {
            ...
            React.createElement('ul', app.mergeAttributes('3', scope, {}, {
                "id": "ul_3",
                "key": app.getKey('id', '3')
              }),
              (function(scope) {
                var out = [];
                var list = scope['food'] = app.methods['4']['food'](scope);
                for (var i = 0; i < list.length; i++) {
                  scope['food_index'] = i;
                  out.push(React.createElement('li', app.mergeAttributes('4', scope, {}, {
                    "id": "li_4",
                    "key": app.getKey('id', '4', i)
                  }), app.methods['4']['food_name'](scope)));
                }
                return out;
              })(scope)))));
    };
